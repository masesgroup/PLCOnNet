...
namespace Org.Apache.Plc4x.JavaNs.Api.Listener
{
    ...
    public partial class MessageExchangeListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("MessageExchangeListener class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public MessageExchangeListener(params object[] args) { }
