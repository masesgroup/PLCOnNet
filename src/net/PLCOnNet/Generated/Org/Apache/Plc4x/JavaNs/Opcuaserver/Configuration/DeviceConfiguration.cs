...
{
    #region DeviceConfiguration declaration
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.plc4x/plc4x-opcua-server/0.12.0/org/apache/plc4x/java/opcuaserver/configuration/DeviceConfiguration.html"/>
    /// </summary>
    public partial class DeviceConfiguration : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DeviceConfiguration>
    {
        const string _bridgeClassName = "org.apache.plc4x.java.opcuaserver.configuration.DeviceConfiguration";
        /// <summary>
        ...
        /// </summary>
        public DeviceConfiguration(params object[] args) : base(args) { }
    ...
    #region DeviceConfiguration implementation
    public partial class DeviceConfiguration
    {
        ...
        {
            get { return IExecuteWithSignature<Java.Util.List<Org.Apache.Plc4x.JavaNs.Opcuaserver.Configuration.Tag>>("getTags", "()Ljava/util/List;"); }
        }
