...
namespace Org.Apache.Plc4x.JavaNs.Api
{
    ...
    public partial class PlcConnection : Org.Apache.Plc4x.JavaNs.Api.IPlcConnection
    {
        ...
        {
            return IExecuteWithSignature<Java.Util.Optional<Org.Apache.Plc4x.JavaNs.Api.Value.PlcValue>>("parseTagValue", "(Lorg/apache/plc4x/java/api/model/PlcTag;[Ljava/lang/Object;)Ljava/util/Optional;", MASES.JNet.Specific.Extensions.JNetCoreExtensions.VarArgRebuild(arg1, arg0));
        }
        /// <summary>
